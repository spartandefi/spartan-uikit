...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#d4af37", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#bb0a1e", textDisabled: "#BDC2C4", textSubtle: "#bb0a1e", borderColor: "#d4af37", card: "#d4af37", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#bb0a1e", background: "#d4af37", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", primaryDark: "#708090", tertiary: "#EFF4F5", text: "#bb0a1e", textDisabled: "#BDC2C4", textSubtle: "#bb0a1e", borderColor: "#d4af37", card: "#d4af37", gradients: {
